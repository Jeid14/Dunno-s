...
public class Constants {
   ...
   public static String[] SQL_NON_SQL = new String[]{ConstantString.DB_CHOSE_DATABASE, ConstantString.DB_CHOSE_POSTGRES, ConstantString.DB_CHOSE_H2, ConstantString.DB_CHOSE_MYSQL, "NonSQL - Graph", "NonSQL - Mongo", "NonSQL - Cassandra"};
